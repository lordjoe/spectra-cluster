...
public class FrankEtAlConsensusSpectrumBuilder implements ConsensusSpectrumBuilder {
    ...
    @Override
    public List<uk.ac.ebi.pride.tools.pride_spectra_clustering.util.Peak> buildConsensusSpectrum(List<List<uk.ac.ebi.pride.tools.pride_spectra_clustering.util.Peak>> spectra) {
