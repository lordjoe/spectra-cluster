...
public class SpringJDBCUtilities {
   ...
   // public static final ParameterizedRowMapper<ISpectralCluster> CLUSTER_MAPPER = new ClusterMapper();
    ...
    //    public static class ModifiedClusterMapper implements ParameterizedRowMapper<IModifiedPeptide> {
//        private ModifiedClusterMapper() {
//        }
//
//        @Override
...
//        return Encrypt.decryptString(ret);
    ...
    public static DataSource getRootDataSource(String host) {
        ...
        if ("cook".equals(host))
            holder.put(DATA_USER_PARAMETER, "lordjoe");
        String pw = getRootPassword(host);
        holder.put(DATA_PASSWORD_PARAMETER, pw);
        holder.put(DATA_DRIVER_CLASS_PARAMETER, "com.mysql.jdbc.Driver");
