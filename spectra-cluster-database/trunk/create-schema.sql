...
(
  ...
  taxonomy_id       VARCHAR2 (100 CHAR) NOT NULL ,
  disease           VARCHAR2 (100 CHAR) ,
  tissue            VARCHAR2 (100 CHAR) ,
  search_engine     VARCHAR2 (100 CHAR) ,
  instrument        VARCHAR2 (100 CHAR) ,
  instrument_type   VARCHAR2 (100 CHAR) ,
...
(
  ...
  similarity  NUMBER (10,4) NOT NULL
) ;
...
ALTER TABLE cluster_run ADD CONSTRAINT cluster_run_PK PRIMARY KEY ( name ) ;
...
(
  ...
  modifications        VARCHAR2 (250 CHAR) ,
  search_engine        VARCHAR2 (250 CHAR) ,
  search_engine_scores VARCHAR2 (250 CHAR) ,
  search_database      VARCHAR2 (250 CHAR) ,
  protein_accession    VARCHAR2 (100 CHAR) ,
...
CREATE UNIQUE INDEX spectrum_ref_IDX ON spectrum
(
  spectrum_ref ASC
)
;
...
ALTER TABLE spectrum ADD CONSTRAINT spectrum_UN UNIQUE ( spectrum_ref ) ;

CREATE TABLE spectrum_cluster
(
  cluster_pk           INTEGER NOT NULL ,
  avg_precursor_mz     NUMBER (7,3) NOT NULL ,
  avg_precursor_charge NUMBER (4,2) NOT NULL ,
  consensus_spectrum_mz BLOB NOT NULL ,
  consensus_spectrum_intensity BLOB NOT NULL ,
  number_of_spectra SMALLINT NOT NULL ,
...
CREATE SEQUENCE cluster_pk_sequence START WITH 1 INCREMENT BY 1000 NOCACHE ORDER ;
