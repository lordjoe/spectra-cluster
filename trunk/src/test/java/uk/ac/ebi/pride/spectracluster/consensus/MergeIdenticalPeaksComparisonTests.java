...
public class MergeIdenticalPeaksComparisonTests {
    ...
    private FrankEtAlConsensusSpectrumBuilder frankEtAlConsensusSpectrumBuilder;
    private uk.ac.ebi.pride.tools.pride_spectra_clustering.consensus_spectrum_builder.impl.FrankEtAlConsensusSpectrumBuilder originalFrankEtAlConsensusSpectrumBuilder;

    @Before
    public void setUp() throws Exception {
        frankEtAlConsensusSpectrumBuilder = new FrankEtAlConsensusSpectrumBuilder();
