...
/* ********  P R I V A T E   F I E L D S  ******** */
    ...
    public static void intToBytes(int value, byte[] data, int start) {
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
    ...
    /**
       * return the resulta of decoding a base64 string as an array of doubles
       * @param base64
       * @return
       */
    public static double[] decodeDoubles(String base64)
    {
        ...
        byte[] decoded =  decode(base64);
         int npeaks = decoded.length /  FLOAT64_SIZE ;

         double[] ret = new double[npeaks];
         for (int i = 0; i < decoded.length; i +=   FLOAT64_SIZE ) {
             ret[i / FLOAT64_SIZE] = bytesToFloat64(decoded, i);
