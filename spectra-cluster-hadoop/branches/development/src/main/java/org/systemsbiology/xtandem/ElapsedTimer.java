...
{
    public static ElapsedTimer[] EMPTY_ARRAY = {};
    public static Class THIS_CLASS = ElapsedTimer.class;
    ...
    public String formatElapsed(String message)
    {
        ...
        if(elapsedSec < 1000 )
             return message+ " in " + XTandemUtilities.formatDouble(elapsedSec,3 ) + " sec";
        if(elapsedSec < 10000 )
             return message+ " in " + XTandemUtilities.formatDouble(elapsedSec / 60,3 ) + " min";
        return message + " in " +XTandemUtilities.formatDouble(elapsedSec / (60 * 60),3 ) + " hour";
     }
