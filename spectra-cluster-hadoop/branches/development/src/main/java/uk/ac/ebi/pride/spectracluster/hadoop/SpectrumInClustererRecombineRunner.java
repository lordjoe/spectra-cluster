...
/**
 * uk.ac.ebi.pride.spectracluster.hadoop.SpectrumInClustererRecombineRunner
 * This uses a key based in charge,peakmz,PrecursorMZ
 * inout is MGF text
 */
public class SpectrumInClustererRecombineRunner extends ConfiguredJobRunner implements IJobRunner {
...
//        }
            ...
            job.setJarByClass(SpectrumInClustererRecombineRunner.class);
            ...
            job.setReducerClass(SpectrumInClustererRecombineReducer.class);
...
//
    ...
    public static void main(String[] args) throws Exception {
        ...
        ToolRunner.run(new SpectrumInClustererRecombineRunner(), args);
    }
}