...
public final class SummaryFactory {
     ...
     * @param spectrumId spectrum id is the primary key assigned at the data store level
     * @return
     */
    public static PSMSummary summarisePSM(PSM psm, String projectAccession,
                                          Long assayId, String assayAccession,
                                          Long spectrumId, int numOfMsRun) {
        PSMSummary psmSummary = new PSMSummary();

        psmSummary.setSpectrumId(spectrumId);
        ...
        // start position
        psmSummary.setStartPosition(psm.getStart());

        // stop position
        psmSummary.setStopPosition(psm.getEnd());
